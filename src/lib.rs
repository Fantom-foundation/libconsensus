...
pub trait Consensus {
    ...
    type Configuration;
    // Consensus data type; specify data type of event to be in consensus on order of.
    type B: AsRef<u8>;
    ...
    fn send_transaction(&mut self, data: Self::B);
    ...
    fn register_callback(&mut self, callback: fn(data: Self::B) -> bool) -> bool;
    ...
    // the order of registration.
    fn register_channel(&mut self, sender: Sender<Self::B>) -> bool;
